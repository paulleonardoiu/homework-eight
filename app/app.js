var homePage = ` <h1 class="header">APARTMENT #1</h1>
<div class="images">
...
var aboutPage = `<h1 class="header">APARTMENT #2</h1>
<div class="images">
...
var imagesPage = `<h1 class="header">APARTMENT #3</h1>
<div class="images">
...
var contactPage = `<h1 class="header">APARTMENT #4</h1>
<div class="images">
